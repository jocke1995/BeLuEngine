...
// Root signatures
enum BL_ROOT_PARAMETER_TYPE
{
    BL_ROOT_PARAMETER_DESCRIPTOR_TABLE,
    BL_ROOT_PARAMETER_32BIT_CONSTANTS,
    BL_ROOT_PARAMETER_CBV,
    BL_ROOT_PARAMETER_SRV,
    BL_ROOT_PARAMETER_UAV
};
