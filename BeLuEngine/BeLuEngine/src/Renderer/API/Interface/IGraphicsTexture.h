...
public:
	...
	virtual bool CreateTexture2D(unsigned int width, unsigned int height, BL_FORMAT blTextureFormat, unsigned int textureUsage /* F_TEXTURE_USAGE */, const std::wstring name, unsigned int mipLevels = 1) = 0;
